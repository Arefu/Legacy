// BytecodeVM_EntityCmd_8025ED4_1arg -- action opcode 121, 0x0800A004 (0x40 bytes). LOW.
// Pops (character, arg) and enqueues a command with vtable 0x08025ED4. What it does is not decoded.
...
void BytecodeVM_EntityCmd_8025ED4_1arg(VmContext* vm, const u8**) {
